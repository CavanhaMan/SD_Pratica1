...
public class ClienteCT extends JFrame implements ActionListener, KeyListener {
    ...
    public ClienteCT() throws IOException{                  
        JLabel lblMessage = new JLabel("CONFIGURAR DADOS DE CONEXÃO");
        JLabel lblIp = new JLabel("Insira o endereço IP do Servidor:");
        txtIP = new JTextField("127.0.0.1");
        JLabel lblPorta = new JLabel("Insira a porta do Servidor:");
        txtPorta = new JTextField("2000");
        JLabel lblNome = new JLabel("Insira o seu nome ou apelido:");
